%% Claudezilla Repository Structure v0.5.6
...
graph TB
    ...
    subgraph HOST["host/<br/>Native Messaging Host"]
        ...
        HOST_IPC["ipc.js<br/>(IPC abstraction - v0.5.6)"]
    ...
    subgraph INSTALL["install/<br/>Setup Scripts"]
        ...
        WIN_INSTALL["install-windows.ps1<br/>(v0.5.6)"]
        WIN_UNINSTALL["uninstall-windows.ps1<br/>(v0.5.6)"]
    ...
    %% Styling for new v0.5.6 components
